...
public class AutoCrystalMax extends Module {
    public static AutoCrystalMax INSTANCE;
    ...
    public AutoCrystalMax() {
        super("AutoCrystalMax", "Recode", Category.Combat);
        INSTANCE = this;
    ...
    public void onRender3D(MatrixStack matrixStack, float partialTicks) {
        ...
        if (AutoCrystalMax.INSTANCE.displayTarget != null && !AutoCrystalMax.INSTANCE.noPosTimer.passedMs(500)) {
            Aura.doRender(matrixStack, partialTicks, AutoCrystalMax.INSTANCE.displayTarget, color.getValue(), mode.getValue());
        }
    }
