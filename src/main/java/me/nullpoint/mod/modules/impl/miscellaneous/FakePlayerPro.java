...
public class FakePlayerPro extends Module {
	public static FakePlayerPro INSTANCE;

	public FakePlayerPro() {
		super("FakePlayerPro", Category.Misc);
		this.setDescription("Spawn fakeplayerpro.");
		INSTANCE = this;
	}

	private final StringSetting name = add(new StringSetting("Name", "FakePlayerPro"));
