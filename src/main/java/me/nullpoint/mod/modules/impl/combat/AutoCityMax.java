...
public class AutoCityMax extends Module {
	public static AutoCityMax INSTANCE;
	private final EnumSetting<Page> page =
			add(new EnumSetting<>("Page", Page.Main));
	...
	BooleanSetting eatingPause =
			add(new BooleanSetting("EatingPause", true, v -> page.getValue() == Page.Main));
	public final SliderSetting targetRange =
			add(new SliderSetting("TargetRange", 6.0, 0.0, 8.0, 0.1));
	public AutoCityMax() {
		super("AutoCityMax", Category.Combat);
		INSTANCE = this;
	}
